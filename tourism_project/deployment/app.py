...
model_path = hf_hub_download(repo_id="Bhargavi329/tourism_package_model", filename="best_tourism_package_model_v1.joblib")
...
if st.button("Upload Deployment Files"):
    ...
    if not HF_TOKEN:
        ...
        api = HfApi()
        repo_id = "Bhargavi329/tourism-package-prediction"  # your Space repo
